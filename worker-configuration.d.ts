/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 42626d1797b9eb984018339ff0e10a4b)
// Runtime types generated with workerd@1.20260714.1 2026-07-20 nodejs_compat
interface __BaseEnv_Env {
	ALLOWED_ORIGINS: "";
	BASE_PATH: "/api/chatgpt";
	COOKIE_NAME: "lwc_session";
	COOKIE_SAME_SITE: "Lax";
	DEFAULT_MODEL: "gpt-5.5";
	OPENAI_ORIGINATOR: "login-with-chatgpt-for-cloudflare";
	OPENAI_USER_AGENT: "login-with-chatgpt-for-cloudflare/0.3.0";
	MAX_REQUEST_BYTES: 16777216;
	RESPONSES_RATE_LIMIT: 30;
	RESPONSES_RATE_WINDOW_SECONDS: 60;
	SESSION_TTL_SECONDS: 2592000;
	SESSION_SECRET: string;
	CHATGPT_SESSIONS: DurableObjectNamespace<import("./src/index").ChatGPTSession>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/index");
		durableNamespaces: "ChatGPTSession";
	}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "ALLOWED_ORIGINS" | "BASE_PATH" | "COOKIE_NAME" | "COOKIE_SAME_SITE" | "DEFAULT_MODEL" | "OPENAI_ORIGINATOR" | "OPENAI_USER_AGENT" | "MAX_REQUEST_BYTES" | "RESPONSES_RATE_LIMIT" | "RESPONSES_RATE_WINDOW_SECONDS" | "SESSION_TTL_SECONDS" | "SESSION_SECRET">> {}
}
